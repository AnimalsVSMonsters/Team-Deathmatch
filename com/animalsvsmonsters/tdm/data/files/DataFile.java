package com.animalsvsmonsters.tdm.data.files;
...
public class DataFile {
	 ...
	 * 
	 */
	public DataFile renameFile(String string) {
		save();
		File nfile = new File(FilenameUtils.getPath(file.getPath()) + string + FilenameUtils.getExtension(file.getPath()));
		file.delete();
		file = new DataFile(nfile).getFile();
		return this;
	}
